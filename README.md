...
JSON-Cache-Kontrakt für load/sync/Mutationen) — velorganize spricht denselben
Kontrakt über `velorganize.caldav` und bleibt damit account-kompatibel zur
...
src/velorganize/
  ...
  notes.py    Markdown-Store (XDG_DATA/velorganize/notes)
qml/
